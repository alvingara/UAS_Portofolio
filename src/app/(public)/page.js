...
export default function Dashboard() {
    ...
    return ( <
        ...
        div >
        <
        span className = "text-[#FFB400]" > Fullstak < /span> Developer  < /
        div > <
        /div> <
        p className = "text-[#767676]" > Perkenalkan nama saya vino mahasiswa aktif dari Politeknik LP3I Jakarta. < /p> <
        ...
        div className = "grid grid-rows-2 grid-flow-col gap-3 mt-10" > {
            myService.
            map((item, key) => < ItemService key = { key }
                title = { item.title }
